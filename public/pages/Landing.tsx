...
import {
  ...
  ShoppingBasket, Pill, Wine, Scissors, Store, RefreshCw, Sparkles, Search,
  Blinds, Croissant, Smartphone, Snowflake, Shirt, Wrench, Hammer,
  BedDouble, UtensilsCrossed, Droplets, Egg, Fuel,
} from "lucide-react";
...
const SHOP_ICON: Record<string, any> = {
  retail: ShoppingBasket, pharmacy: Pill, bar: Wine, tailoring: Scissors,
  blinds: Blinds, bakery: Croissant, electronics: Smartphone, coldroom: Snowflake,
  laundry: Shirt, autorepair: Wrench, buildingmaterials: Hammer, salon: Sparkles,
  hotel: BedDouble, restaurant: UtensilsCrossed, water: Droplets, poultry: Egg,
  filling: Fuel,
};
      ...
      {!loading && shops.length > 6 && (
        <div className="relative mb-4">
          ...
          <input
            ...
            placeholder={`Search ${shops.length} trades — pharmacy, poultry, hotel…`}
